...
<required_reading>
@/Users/apaderin/dev/octoconv/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/Users/apaderin/dev/octoconv/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/apaderin/dev/octoconv/.claude
                  → checks /Users/apaderin/dev/octoconv/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/apaderin/dev/octoconv/.claude/get-shit-done
                  → writes to /Users/apaderin/dev/octoconv/.claude/get-shit-done/hooks/
...
@/Users/apaderin/dev/octoconv/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/apaderin/dev/octoconv/.claude/get-shit-done/references/common-bug-patterns.md
