...
Reference full template: `/Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/state.md`.
