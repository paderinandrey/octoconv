...
Use template from `/Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/UI-SPEC.md`
