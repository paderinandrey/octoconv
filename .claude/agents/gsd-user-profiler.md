...
<reference>
@/Users/apaderin/dev/octoconv/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/apaderin/dev/octoconv/.claude/get-shit-done/references/user-profiling.md` to load:
