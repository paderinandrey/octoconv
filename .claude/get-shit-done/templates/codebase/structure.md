...
- Usage: Reference from command with `@/Users/apaderin/dev/octoconv/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/apaderin/dev/octoconv/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/apaderin/dev/octoconv/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
