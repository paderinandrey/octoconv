...
See /Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/discovery.md
...
Use /Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/discovery.md.
