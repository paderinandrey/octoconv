...
```bash
INIT=$(node "/Users/apaderin/dev/octoconv/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/apaderin/dev/octoconv/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
