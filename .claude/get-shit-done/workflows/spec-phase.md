...
```bash
INIT=$(node "/Users/apaderin/dev/octoconv/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/spec.md.
