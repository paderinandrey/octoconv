...
INSTALL_JS_GLOBAL="/Users/apaderin/dev/octoconv/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/apaderin/dev/octoconv/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
