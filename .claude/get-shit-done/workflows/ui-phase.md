...
```markdown
Read /Users/apaderin/dev/octoconv/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/apaderin/dev/octoconv/.claude/agents/gsd-ui-checker.md for instructions.
