...
```
Agent(
  prompt="Read /Users/apaderin/dev/octoconv/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/apaderin/dev/octoconv/.claude/get-shit-done/templates/VALIDATION.md`
