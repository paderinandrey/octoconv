...
- [ ] Кросс-конвертация внутри документного класса (docx↔odt, xlsx↔ods, pptx↔odp) через существующие API/очереди/воркер
- [ ] Запароленные/legacy OLE-CFB документы отклоняются с 422 на входе, до конвертации
...
---
*Last updated: 2026-07-10 after v1.3 milestone start*
