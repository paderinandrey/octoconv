...
**Plans**: 3 plans
  - [ ] 28-01-PLAN.md — Chart fixes: WR-02 field-level replicas omission on the 3 scaled Deployments (D-10) + document ScaledObject scaleDown-stabilization override + document-worker extraEnv + values-loadproof.yaml overlay
...
| 28. Autoscale Load-Proof | v1.6 | 0/3 | Planned | - |
